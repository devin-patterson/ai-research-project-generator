...
class SemanticScholarSearch(BaseAcademicSearch):
    ...
    def search(self, query: str, limit: int = 10, offset: int = 0, 
               ...
               open_access_only: bool = False) -> SearchResult:
        """
...
class OpenAlexSearch(BaseAcademicSearch):
    ...
    def search(self, query: str, limit: int = 10, offset: int = 0,
               ...
               sort_by: str = "relevance_score") -> SearchResult:
        """
...
class UnifiedAcademicSearch:
    ...
    def search_all(self, query: str, limit_per_source: int = 10,
                   year_range: Optional[tuple] = None,
                   sources: Optional[List[str]] = None) -> Dict[str, SearchResult]:
        """
        ...
        if "arxiv" in sources:
            ...
            results["arxiv"] = self.arxiv.search(
                query, limit=limit_per_source
            )
        
        return results
    
    def search_merged(self, query: str, limit: int = 20,
                      year_range: Optional[tuple] = None,
