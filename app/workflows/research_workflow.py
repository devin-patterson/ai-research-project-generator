...
class ResearchWorkflow:
    ...
    async def _recommend_methodology(self, state: ResearchState) -> dict[str, Any]:
        ...
        recommendations = methodology_map.get(
            research_type,
            methodology_map["literature_review"]
        )
    ...
    async def _llm_analyze_topic(
        self, topic: str, research_question: str
    ) -> dict[str, Any]:
    ...
    def _rule_based_topic_analysis(
        self, topic: str, research_question: str
    ) -> dict[str, Any]:
