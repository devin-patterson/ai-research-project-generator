...
Format your response as a structured analysis."""
    ...
    def generate_research_questions(self, topic: str, research_type: str, context: str = "") -> List[str]:
...
Format: Return each question on a new line, numbered 1-7."""
    ...
    def recommend_methodology(self, topic: str, research_question: str, discipline: str) -> Dict[str, Any]:
...
RECOMMENDED_MODELS = {
    "best_quality": {
        "ollama": [
            {"name": "llama3.1:70b", "vram": "48GB+", "context": "128K", "notes": "Best quality, needs high-end GPU"},
            {"name": "qwen2.5:32b", "vram": "24GB+", "context": "128K", "notes": "Excellent for research, Apache-2.0"},
            {"name": "mixtral:8x7b", "vram": "24GB+", "context": "32K", "notes": "MoE, good throughput"}
        ],
        "description": "Best quality models for comprehensive research analysis"
    },
    "balanced": {
        "ollama": [
            {"name": "llama3.1:8b", "vram": "8GB+", "context": "128K", "notes": "Great balance of quality/speed"},
            {"name": "qwen2.5:14b", "vram": "12GB+", "context": "128K", "notes": "Strong reasoning, Apache-2.0"},
            {"name": "gemma2:9b", "vram": "8GB+", "context": "8K", "notes": "Efficient, good quality"}
        ],
        "description": "Balanced models for most research tasks"
    },
    "lightweight": {
        "ollama": [
            {"name": "llama3.2:3b", "vram": "4GB+", "context": "128K", "notes": "Small but capable"},
            {"name": "phi4:3.8b", "vram": "4GB+", "context": "128K", "notes": "Excellent reasoning for size"},
    ...
    "reasoning": {
        "ollama": [
            {"name": "deepseek-r1:7b", "vram": "8GB+", "context": "64K", "notes": "Strong reasoning/math"},
            {"name": "phi4-reasoning:14b", "vram": "12GB+", "context": "32K", "notes": "Chain-of-thought"},
            {"name": "qwen2.5-coder:7b", "vram": "6GB+", "context": "128K", "notes": "Good for data analysis"}
        ],
