        ...
        **kwargs
        ...
        comprehensive_project = {
            ...
            "metadata": {
                ...
                "critical_issues": len([i for i in validation_report.issues if i.level.value == "critical"])
            }
        }
        
        logger.info(f"Comprehensive project generated. Quality score: {validation_report.overall_score:.2f}")
        return comprehensive_project
    
    def export_project(self, project: Dict, format: str = "json", output_path: Optional[str] = None) -> str:
        """
...
def main():
    ...
    parser.add_argument("--type", required=True, choices=[t.value for t in ResearchType], help="Research type")
    parser.add_argument("--level", required=True, choices=[l.value for l in AcademicLevel], help="Academic level")
    ...
    parser.add_argument("--format", default="markdown", choices=["json", "markdown", "html"], help="Output format")
