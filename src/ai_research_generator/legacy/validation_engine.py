...
class ValidationEngine:
    ...
    def validate_project(self, project_data: Dict) -> ValidationReport:
        ...
        report.enhancement_opportunities = self._identify_enhancement_opportunities(
            project_data, report.issues
        )
    ...
    def _check_prisma_compliance(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            ...
            "description": f"Missing PRISMA elements: {', '.join(missing_elements)}"
            if missing_elements
            else "PRISMA elements present",
            "suggestion": "Include all required PRISMA elements in methodology",
            "auto_fixable": False,
        }

    def _check_search_strategy_completeness(
        self, literature_search: Dict, project_data: Dict
    ) -> Dict:
        ...
        return {
            "passed": len(missing_elements) == 0,
            "description": f"Missing search elements: {', '.join(missing_elements)}"
            if missing_elements
            else "Search strategy complete",
    ...
    def _check_quality_assessment(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            "passed": has_quality,
            "description": "Quality assessment mentioned"
            if has_quality
            else "No quality assessment found",
    ...
    def _check_theoretical_framework(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            ...
            "description": f"Theoretical framework: {framework}"
            if framework
            else "No theoretical framework specified",
    ...
    def _check_data_collection_methods(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            ...
            "description": f"Data collection methods: {', '.join(methods)}"
            if methods
            else "No data collection methods",
    ...
    def _check_trustworthiness_criteria(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            ...
            "description": "Trustworthiness criteria addressed"
            if has_trustworthiness
            else "No trustworthiness criteria",
    ...
    def _check_sample_size_justification(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            ...
            "description": "Sample size justified"
            if has_justification
            else "No sample size justification",
    ...
    def _check_statistical_power(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            "passed": has_power,
            "description": "Statistical power considered"
            if has_power
            else "No statistical power consideration",
    ...
    def _check_measurement_validity(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            "passed": has_validity,
            "description": "Measurement validity addressed"
            if has_validity
            else "No measurement validity",
    ...
    def _check_database_coverage(self, literature_search: Dict, project_data: Dict) -> Dict:
        ...
        return {
            ...
            "description": f"Using {len(databases)} databases"
            if databases
            else "No databases specified",
    ...
    def _check_inclusion_criteria(self, literature_search: Dict, project_data: Dict) -> Dict:
        ...
        return {
            ...
            "description": f"Has {len(criteria)} inclusion criteria"
            if criteria
            else "No inclusion criteria",
            "suggestion": "Include specific inclusion criteria (study type, population, etc.)",
            "auto_fixable": False,
        }

    def _check_time_range_appropriateness(
        self, literature_search: Dict, project_data: Dict
    ) -> Dict:
    ...
    def _check_question_clarity(self, research_questions: List[str], project_data: Dict) -> Dict:
        ...
        for question in research_questions:
            ...
            if not any(
                ...
                for word in ["what", "how", "why", "whether", "to what extent"]
            ):
                unclear_questions.append(question)

        return {
            "passed": len(unclear_questions) == 0,
            "description": f"Unclear questions: {len(unclear_questions)}"
            if unclear_questions
            else "Questions are clear",
            "suggestion": "Start questions with what/how/why/whether for clarity",
            "auto_fixable": False,
        }

    def _check_question_feasibility(
        self, research_questions: List[str], project_data: Dict
    ) -> Dict:
        ...
        return {
            ...
            "description": f"Potentially unfeasible questions: {len(unfeasible_questions)}"
            if unfeasible_questions
            else "Questions appear feasible",
    ...
    def _check_informed_consent(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            "passed": has_consent,
            "description": "Informed consent addressed"
            if has_consent
            else "No informed consent mentioned",
    ...
    def _check_confidentiality(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            ...
            "description": "Confidentiality addressed"
            if has_confidentiality
            else "No confidentiality measures",
    ...
    def _check_ethical_approval(self, methodology: Dict, project_data: Dict) -> Dict:
        ...
        return {
            "passed": has_approval,
            "description": "Ethical approval mentioned"
            if has_approval
            else "No ethical approval mentioned",
    ...
    def _generate_recommendations(self, issues: List[ValidationIssue]) -> List[str]:
        ...
        if critical_issues:
            recommendations.append(
                "Address all critical issues before proceeding with the research"
            )

        if len(critical_issues) > 3:
            recommendations.append(
                "Consider simplifying the research scope to address critical issues"
            )
        ...
        literature_issues = [
            i for i in issues if i.category == ValidationCategory.LITERATURE_SEARCH
        ]
    ...
    def _identify_enhancement_opportunities(
        self, project_data: Dict, issues: List[ValidationIssue]
    ) -> List[str]:
...
"""
        ...
        for category, counts in categories.items():
            ...
            if total > 0:
                md += (
                    f"{total} issues ({counts['critical']} critical, {counts['warning']} warnings)"
                )
            else:
                md += "No issues"
...
def main():
    ...
    project_data = {
        ...
        "timeline": {"Literature Review": "4-6 weeks", "Data Collection": "8-12 weeks"},
    }
